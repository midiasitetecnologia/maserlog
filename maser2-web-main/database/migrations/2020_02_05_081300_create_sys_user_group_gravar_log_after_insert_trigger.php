...
class CreateSysUserGroupGravarLogAfterInsertTrigger extends Migration
{
    /**
     *
    ...
    public function up()
    {   
        DB::unprepared('DROP TRIGGER IF EXISTS tr_sys_user_group_gravar_log_after_insert');
        DB::unprepared('
            CREATE TRIGGER tr_sys_user_group_gravar_log_after_insert AFTER INSERT ON sys_user_group FOR EACH ROW
                BEGIN                                    
                    ...
                    IF (IFNULL(NEW.user_id, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "sys_user_group", "insert", "id", NEW.id, @client_addr, "user_id", NEW.user_id
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.sys_group_id, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "sys_user_group", "insert", "id", NEW.id, @client_addr, "sys_group_id", NEW.sys_group_id
                        );
                    END IF;
