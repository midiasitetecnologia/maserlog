...
class AlterColetaFixaGravarLogAfterDeleteTrigger006 extends Migration
{
    /**
     *
            ...
            CREATE TRIGGER tr_coleta_fixa_gravar_log_after_delete AFTER DELETE ON coleta_fixa FOR EACH ROW
                BEGIN                
                    ...
                    IF (IFNULL(OLD.sis_carga, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "sis_carga", OLD.sis_carga
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(OLD.aceitar_foto_rom, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "aceitar_foto_rom", OLD.aceitar_foto_rom
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(OLD.ocultar_resumo, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "ocultar_resumo", OLD.ocultar_resumo
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(OLD.tipo_frete, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "tipo_frete", OLD.tipo_frete
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(OLD.autoriza_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value
                        ) 
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "autoriza_coleta", OLD.autoriza_coleta
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(OLD.caract_coleta, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "caract_coleta", OLD.caract_coleta
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(OLD.hr_prev_entrega, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta_fixa", "delete", "id", OLD.id, @client_addr, "hr_prev_entrega", OLD.hr_prev_entrega
                        ); 
                    END IF;
