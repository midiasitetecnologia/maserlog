<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('pt_BR')"><img class="h-4 w-5 mr-1" src="@assets/images/flags/pt_BR.png" alt="pt_BR" /> &nbsp;Português</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
...
export default {
  computed: {
    i18n_locale_img() {
        ...
        else if (locale == "pt_BR") return require(`@assets/images/flags/pt_BR.png`)
    ...
    getCurrentLocaleData() {
        ...
        else if (locale == "pt_BR") return { flag: "br", lang: 'Português' }
