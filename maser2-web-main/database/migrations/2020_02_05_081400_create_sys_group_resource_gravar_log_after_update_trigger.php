...
class CreateSysGroupResourceGravarLogAfterUpdateTrigger extends Migration
{
    /**
     *
    ...
    public function up()
    {
        DB::unprepared('DROP TRIGGER IF EXISTS tr_sys_group_resource_gravar_log_after_update');
        DB::unprepared('
            CREATE TRIGGER tr_sys_group_resource_gravar_log_after_update AFTER UPDATE ON sys_group_resource FOR EACH ROW
                BEGIN
                    ...
                    IF (IFNULL(OLD.sys_group_id, "") != IFNULL(NEW.sys_group_id, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "sys_group_resource", "update", "id", NEW.id, @client_addr, "sys_group_id", OLD.sys_group_id, 
                          NEW.sys_group_id
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(OLD.sys_resource_id, "") != IFNULL(NEW.sys_resource_id, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "sys_group_resource", "update", "id", NEW.id, @client_addr, "sys_resource_id", OLD.sys_resource_id, 
                          NEW.sys_resource_id
                        );
                    END IF;
