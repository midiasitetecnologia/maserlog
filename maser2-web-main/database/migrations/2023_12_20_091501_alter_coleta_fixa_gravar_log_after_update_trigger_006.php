...
class AlterColetaFixaGravarLogAfterUpdateTrigger006 extends Migration
{
	/**
	 *
            ...
            CREATE TRIGGER tr_coleta_fixa_gravar_log_after_update AFTER UPDATE ON coleta_fixa FOR EACH ROW
                BEGIN
					...
					IF (IFNULL(OLD.ocultar_resumo, "") != IFNULL(NEW.ocultar_resumo, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "update", "id", NEW.id, @client_addr, "ocultar_resumo", 
                          OLD.ocultar_resumo, NEW.ocultar_resumo
                        ); 
                    END IF;
					...
					IF (IFNULL(OLD.tipo_frete, "") != IFNULL(NEW.tipo_frete, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "update", "id", NEW.id, @client_addr, "tipo_frete", 
					...
					IF (IFNULL(OLD.autoriza_coleta, "") != IFNULL(NEW.autoriza_coleta, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "update", "id", NEW.id, @client_addr, "autoriza_coleta", 
                          OLD.autoriza_coleta, NEW.autoriza_coleta
                        ); 
                    END IF;
					...
					IF (IFNULL(OLD.caract_coleta, "") != IFNULL(NEW.caract_coleta, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "update", "id", NEW.id, @client_addr, "caract_coleta", 
                          OLD.caract_coleta, NEW.caract_coleta
                        ); 
                    END IF;
