...
class CreateColetaGravarLogAfterInsertTrigger extends Migration
{
    /**
     *
        ...
        DB::unprepared('
            CREATE TRIGGER tr_coleta_gravar_log_after_insert AFTER INSERT ON coleta FOR EACH ROW
                BEGIN                                    
                    ...
                    IF (IFNULL(NEW.tipo_carga, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "tipo_carga", NEW.tipo_carga
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.km_inicial, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "km_inicial", NEW.km_inicial
                        );                    
                    END IF;

                    IF (IFNULL(NEW.km_final, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "km_final", NEW.km_final
                        );                    
                    END IF;

                    IF (IFNULL(NEW.geo_lat_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "geo_lat_coleta", NEW.geo_lat_coleta
                        );                    
                    END IF;

                    IF (IFNULL(NEW.geo_lng_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "geo_lng_coleta", NEW.geo_lng_coleta
                        );                    
                    END IF;

                    IF (IFNULL(NEW.geo_lat_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "geo_lat_entrega", NEW.geo_lat_entrega
                        );                    
                    END IF;

                    IF (IFNULL(NEW.geo_lng_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "geo_lng_entrega", NEW.geo_lng_entrega
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.descarga_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "descarga_coleta", NEW.descarga_coleta
                        );                    
                    END IF;                   

                    IF (IFNULL(NEW.dt_descarga_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "dt_descarga_coleta", NEW.dt_descarga_coleta
                        );                    
                    END IF;                                      
