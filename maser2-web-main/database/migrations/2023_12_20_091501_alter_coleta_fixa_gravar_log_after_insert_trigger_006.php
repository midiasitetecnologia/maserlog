...
class AlterColetaFixaGravarLogAfterInsertTrigger006 extends Migration
{
  /**
   *
            ...
            CREATE TRIGGER tr_coleta_fixa_gravar_log_after_insert AFTER INSERT ON coleta_fixa FOR EACH ROW
                BEGIN                                    
					...
					IF (IFNULL(NEW.ocultar_resumo, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "insert", "id", NEW.id, @client_addr, "ocultar_resumo", 
                          NEW.ocultar_resumo
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(NEW.tipo_frete, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "insert", "id", NEW.id, @client_addr, "tipo_frete", 
                          NEW.tipo_frete
                        ); 
                    END IF;
                    ...
                    IF (IFNULL(NEW.autoriza_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "insert", "id", NEW.id, @client_addr, "autoriza_coleta", 
                          NEW.autoriza_coleta
                        ); 
                    END IF;					
					...
					IF (IFNULL(NEW.caract_coleta, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta_fixa", "insert", "id", NEW.id, @client_addr, "caract_coleta", 
                          NEW.caract_coleta
                        ); 
                    END IF;
