...
class AlterColetaGravarLogAfterUpdateTrigger014 extends Migration
{
	/**
	 *
		...
		DB::unprepared('
            CREATE TRIGGER tr_coleta_gravar_log_after_update AFTER UPDATE ON coleta FOR EACH ROW
                BEGIN
					...
					IF (IFNULL(OLD.local_coleta_cmd, "") != IFNULL(NEW.local_coleta_cmd, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "local_coleta_cmd", OLD.local_coleta_cmd, 
                          NEW.local_coleta_cmd
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.local_entrega_cmd, "") != IFNULL(NEW.local_entrega_cmd, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "local_entrega_cmd", OLD.local_entrega_cmd, 
                          NEW.local_entrega_cmd
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.hr_partida_coleta, "") != IFNULL(NEW.hr_partida_coleta, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "hr_partida_coleta", OLD.hr_partida_coleta, 
                          NEW.hr_partida_coleta
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.cod_tipo_veiculo_nec, "") != IFNULL(NEW.cod_tipo_veiculo_nec, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "cod_tipo_veiculo_nec", OLD.cod_tipo_veiculo_nec, 
                          NEW.cod_tipo_veiculo_nec
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.hr_partida_entrega, "") != IFNULL(NEW.hr_partida_entrega, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "hr_partida_entrega", OLD.hr_partida_entrega, 
                          NEW.hr_partida_entrega
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.tempo_desloc_pavilhao, "") != IFNULL(NEW.tempo_desloc_pavilhao, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "tempo_desloc_pavilhao", OLD.tempo_desloc_pavilhao, 
                          NEW.tempo_desloc_pavilhao
                        );                    
                    END IF;

					IF (IFNULL(OLD.entrega_consolidada, "") != IFNULL(NEW.entrega_consolidada, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "entrega_consolidada", OLD.entrega_consolidada, 
                          NEW.entrega_consolidada
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.aceitar_foto_rom, "") != IFNULL(NEW.aceitar_foto_rom, "")) THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "aceitar_foto_rom", OLD.aceitar_foto_rom, 
                          NEW.aceitar_foto_rom
                        );                    
					END IF;

					IF (IFNULL(OLD.ocultar_resumo, "") != IFNULL(NEW.ocultar_resumo, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "ocultar_resumo", OLD.ocultar_resumo, 
                          NEW.ocultar_resumo
                        );                    
					END IF;

          			IF (IFNULL(OLD.tipo_frete, "") != IFNULL(NEW.tipo_frete, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "tipo_frete", OLD.tipo_frete, 
                          NEW.tipo_frete
                        );                    
					END IF;

					IF (IFNULL(OLD.sit_nf_frete, "") != IFNULL(NEW.sit_nf_frete, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "sit_nf_frete", OLD.sit_nf_frete, 
                          NEW.sit_nf_frete
                        );                    
					END IF;
					...
					IF (IFNULL(OLD.baldeada, "") != IFNULL(NEW.baldeada, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "baldeada", OLD.baldeada, 
                          NEW.baldeada
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.carga_pavilhao, "") != IFNULL(NEW.carga_pavilhao, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "carga_pavilhao", OLD.carga_pavilhao, 
                          NEW.carga_pavilhao
                        );                    
                    END IF;
					...
					IF (IFNULL(OLD.mot_nao_entrega, "") != IFNULL(NEW.mot_nao_entrega, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "mot_nao_entrega", OLD.mot_nao_entrega, 
                          NEW.mot_nao_entrega
                        );                    
					END IF;
					
					IF (IFNULL(OLD.obs_nao_entrega, "") != IFNULL(NEW.obs_nao_entrega, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "obs_nao_entrega", OLD.obs_nao_entrega, 
                          NEW.obs_nao_entrega
                        );                    
					END IF;
					
					IF (IFNULL(OLD.reentrega, "") != IFNULL(NEW.reentrega, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "reentrega", OLD.reentrega, 
                          NEW.reentrega
                        );                    
					END IF;
					
					IF (IFNULL(OLD.reentrega_gerada, "") != IFNULL(NEW.reentrega_gerada, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "reentrega_gerada", OLD.reentrega_gerada, 
                          NEW.reentrega_gerada
                        );                    
					END IF;

					IF (IFNULL(OLD.solic_reentrega_id, "") != IFNULL(NEW.solic_reentrega_id, "")) THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "update", "id", NEW.id, @client_addr, "solic_reentrega_id", OLD.solic_reentrega_id, 
                          NEW.solic_reentrega_id
                        );                    
					END IF;
