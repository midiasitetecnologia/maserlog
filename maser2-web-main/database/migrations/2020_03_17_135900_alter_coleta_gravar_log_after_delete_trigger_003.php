...
class AlterColetaGravarLogAfterDeleteTrigger003 extends Migration
{
    /**
     *
        ...
        DB::unprepared('
            CREATE TRIGGER tr_coleta_gravar_log_after_delete AFTER DELETE ON coleta FOR EACH ROW
                BEGIN                
                    ...
                    IF (IFNULL(OLD.dt_desloca_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value
                        ) 
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta", "delete", "id", OLD.id, @client_addr, "dt_desloca_coleta", OLD.dt_desloca_coleta
                        );
                    END IF;
                    ...
                    IF (IFNULL(OLD.dt_desloca_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value
                        ) 
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta", "delete", "id", OLD.id, @client_addr, "dt_desloca_entrega", OLD.dt_desloca_entrega
                        );
                    END IF;

                    IF (IFNULL(OLD.km_ini_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value
                        ) 
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta", "delete", "id", OLD.id, @client_addr, "km_ini_entrega", OLD.km_ini_entrega
                        );
                    END IF;

                    IF (IFNULL(OLD.km_fim_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, old_value
                        ) 
                        VALUES 
                        ( @uuid, OLD.ass_user_id, @date_time, "coleta", "delete", "id", OLD.id, @client_addr, "km_fim_entrega", OLD.km_fim_entrega
                        );
                    END IF;
