...
class WisdomRequest extends FormRequest
{
    ...
    {
        return [
            'texto.required' => 'O texto deve ser informado.',
            'fonte.required' => 'A fonte é obrigatória.',
            'fonte.max' => 'A fonte deve ter no máximo :max caracteres.',
        ];
    }

    public function ValidarDadosApiWisdom($data)
    {
