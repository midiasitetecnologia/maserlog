...
class AlterColetaGravarLogAfterInsertTrigger014 extends Migration
{
    /**
     *
        ...
        DB::unprepared('
            CREATE TRIGGER tr_coleta_gravar_log_after_insert AFTER INSERT ON coleta FOR EACH ROW
                BEGIN                                    
                    ...
                    IF (IFNULL(NEW.hr_partida_coleta, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "hr_partida_coleta", NEW.hr_partida_coleta
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.hr_partida_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "hr_partida_entrega", NEW.hr_partida_entrega
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.tempo_desloc_pavilhao, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "tempo_desloc_pavilhao", NEW.tempo_desloc_pavilhao
                        );                    
                    END IF;

                    IF (IFNULL(NEW.entrega_consolidada, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "entrega_consolidada", NEW.entrega_consolidada
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.aceitar_foto_rom, "") != "") THEN
                        ...
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "aceitar_foto_rom", NEW.aceitar_foto_rom
                        );                    
                    END IF;

                    IF (IFNULL(NEW.ocultar_resumo, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "ocultar_resumo", NEW.ocultar_resumo
                        );                    
                    END IF;

                    IF (IFNULL(NEW.tipo_frete, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "tipo_frete", NEW.tipo_frete
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.carga_pavilhao, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "carga_pavilhao", NEW.carga_pavilhao
                        );                    
                    END IF;
                    ...
                    IF (IFNULL(NEW.mot_nao_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "mot_nao_entrega", NEW.mot_nao_entrega
                        );                    
                    END IF;

                    IF (IFNULL(NEW.obs_nao_entrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "obs_nao_entrega", NEW.obs_nao_entrega
                        );                    
                    END IF;

                    IF (IFNULL(NEW.reentrega, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "reentrega", NEW.reentrega
                        );                    
                    END IF;

                    IF (IFNULL(NEW.reentrega_gerada, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "reentrega_gerada", NEW.reentrega_gerada
                        );                    
                    END IF;

                    IF (IFNULL(NEW.solic_reentrega_id, "") != "") THEN
                        INSERT INTO user_log 
                        ( uuid, user_id, date_time, table_name, operation, pk, pk_value, client_addr, column_name, new_value
                        ) 
                        VALUES 
                        ( @uuid, NEW.ass_user_id, @date_time, "coleta", "insert", "id", NEW.id, @client_addr, "solic_reentrega_id", NEW.solic_reentrega_id
                        );                    
                    END IF;
